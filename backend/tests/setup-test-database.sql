...
DROP DATABASE IF EXISTS `project_x_test`;
CREATE DATABASE `project_x_test`;
USE `project_x_test`;
...
('Jane', 'Doe','jane@doe.com', 'test123', 'xxx', '2', true),
('duplicate', 'test', 'duplicate@test.com', 'xxx', 'test123', 2, true),
('update', 'test','update@test.com', 'test123', 'xxx', '2', true),
('inactive', 'test','inactive@test.com', 'test123', 'xxx', '2', false);
...
(1, 'light', 'large', 'en', 'MM/DD/YYYY', 'America/New_York'),
